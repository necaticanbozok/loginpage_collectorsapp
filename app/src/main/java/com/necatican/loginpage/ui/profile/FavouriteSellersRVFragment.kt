...
class FavouriteSellersRVFragment :  BaseFragment<FragmentFavouriteSellersRvBinding>(FragmentFavouriteSellersRvBinding::inflate) {
    ...
    private fun loadData() : List<Items>{
        ...
        for (i in 1..10) {
            myList.add(Items(adImage = R.drawable.profile_pic, adName = "$i.Emre"))
        }
        return  myList
    }
